...
const Header = () => {
  ...
  return (
    <div className=" w-[100vw] z-[9999] "style={glowEffect }>
        ...
        <div className="flex w-full justify-between items-center">
          ...
          <div>
            <ul className="flex items-center gap-4 relative">
              ...
              {/* Language Dropdown */}
              {openLanguage && (
                <div className="flex flex-col items-center justify-center w-24 z-999 absolute top-10 right-[115px] bg-black rounded-lg shadow-md cursor-pointer">
                  <ul>
                    {lang.map((item) => (
                      <li
                        key={item.id}
